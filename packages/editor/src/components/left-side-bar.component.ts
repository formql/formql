...
import { InternalEventHandlerService, InternalEventType, WrapperType, FormQLMode } from '@formql/core';

@Component({
    selector: 'formQLLeftSideBar',
    template: `<div class="fql-left-menu">
                    <div class="fql-left-menu-page" (click)="editPage()" title="Click to configure Page properties">
                    ...
                    <div class="fql-left-menu-section" dnd-new [type]="WrapperType.Section" [mode]="mode" draggable="true" title="Drag and drop into a Page to add Section">
                    ...
                    <div class="fql-left-menu-component" dnd-new [type]="WrapperType.Component" [mode]="mode" draggable="true" title="Drag and drop into a Section to add Component">
