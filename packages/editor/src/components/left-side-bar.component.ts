...
@Component({
    ...
    template: `<div class="flq-left-menu">
                    <div class="flq-left-menu-page" (click)="editPage()" title="Click to configure Page properties">
                    ...
                    <div class="flq-left-menu-section" dnd-new [type]="WrapperType.Section" [mode]="mode" draggable="true" title="Drag and drop into a Page to add Section">
                    ...
                    <div class="flq-left-menu-component" dnd-new [type]="WrapperType.Component" [mode]="mode" draggable="true" title="Drag and drop into a Section to add Component">
